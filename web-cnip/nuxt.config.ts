export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'description', content: 'cnip.io 提供快速精准的 IP 归属地查询服务，支持 IPv4/IPv6 地址与域名解析，覆盖国家、城市、运营商、ASN、坐标、时区等字段。' },
        { name: 'keywords', content: 'IP查询,IP归属地,IP geolocation,IPv4,IPv6,ASN查询,域名解析,IP定位,cnip.io,ip2region' },
        { property: 'og:title', content: 'cnip.io - IP Geolocation Lookup' },
        { property: 'og:description', content: '快速精准的 IP 归属地查询，支持 IPv4/IPv6 与域名解析' },
        { property: 'og:type', content: 'website' },
        { property: 'og:url', content: 'https://cnip.io' },
        { property: 'og:site_name', content: 'cnip.io' },
        { name: 'twitter:card', content: 'summary' },
        { name: 'twitter:title', content: 'cnip.io - IP Geolocation Lookup' },
  ...
  runtimeConfig: {
    public: {
      ...
      mapBaseUrl: process.env.NUXT_PUBLIC_MAP_BASE_URL || 'https://map.cleanip.io'
    }
  },
  vite: {
    define: {
